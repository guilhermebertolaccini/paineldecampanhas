...
import { Plus, Edit2, Trash2, Database, Link2, CheckCircle, Loader2, Server } from "lucide-react";
          ...
          <CardContent className="space-y-6">
            {hasAnyMssqlWpOverride && (
              <Alert>
                ...
                <AlertDescription>
                  Há <code className="text-xs">define(&apos;PC_MSSQL_*&apos;)</code> ativos: eles prevalecem sobre os
                  campos abaixo. Ajuste o arquivo ou remova as constantes para usar só estas opções.
                </AlertDescription>
              </Alert>
            )}
              ...
              <>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="space-y-2 sm:col-span-2">
                    ...
                    />
                    <p className="text-xs text-muted-foreground">
                      Usado em <code className="text-xs">SELECT</code> sobre views remotas (ex.: campanhas por base MSSQL).
                    </p>
                  </div>
                </div>
                <Button
