...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400 mt-2">Configure credenciais, URLs e integrações com o microserviço
        </p>
    </div>
    ...
    <div class="mb-6 border-b border-gray-200 dark:border-gray-700">
        <nav class="flex space-x-8">
            <button id="tab-view"
                class="tab-button active px-4 py-2 text-sm font-medium border-b-2 border-blue-500 text-blue-600 dark:text-blue-400">
    ...
    <div id="view-tab-content" class="tab-content">
        <!-- Microserviço Config -->
        <div
            class="bg-white dark:bg-surface-dark rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
            ...
            <form id="microservice-form" class="space-y-4">
                <div>
                    ...
                    <input type="url" id="microservice-url" name="microservice_url"
                ...
                <div>
                    ...
                    <input type="text" id="microservice-api-key" name="microservice_api_key"
                        value="<?php echo esc_attr($microservice_config['api_key']); ?>" placeholder="sua-api-key-aqui"
                        class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                        required>
                </div>
                <button type="submit"
        ...
        <div
            ...
            <form id="master-key-form" class="space-y-4">
                <div>
                    ...
                    <input type="text" id="master-api-key" name="master_api_key"
            ...
            <form id="static-credentials-form" class="space-y-6">
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 pb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">CDA API
                                URL</label>
                            <input type="url" name="cda_api_url"
                                value="<?php echo esc_attr($static_credentials['cda_api_url'] ?? ''); ?>"
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">CDA API
                                Key</label>
                            <input type="text" name="cda_api_key"
                                value="<?php echo esc_attr($static_credentials['cda_api_key'] ?? ''); ?>"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Client
                                ID</label>
                            <input type="text" name="sf_client_id"
                                value="<?php echo esc_attr($static_credentials['sf_client_id'] ?? ''); ?>"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Client
                                Secret</label>
                            <input type="password" name="sf_client_secret"
                                value="<?php echo esc_attr($static_credentials['sf_client_secret'] ?? ''); ?>"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                        </div>
                        <div>
                            <label
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Username</label>
                            <input type="text" name="sf_username"
                                value="<?php echo esc_attr($static_credentials['sf_username'] ?? ''); ?>"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                        </div>
                        <div>
                            ...
                            <input type="password" name="sf_password"
                                value="<?php echo esc_attr($static_credentials['sf_password'] ?? ''); ?>"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Token
                                URL</label>
                            <input type="url" name="sf_token_url"
                                value="<?php echo esc_attr($static_credentials['sf_token_url'] ?? 'https://concilig.my.salesforce.com/services/oauth2/token'); ?>"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">API
                                URL</label>
                            <input type="url" name="sf_api_url"
                                value="<?php echo esc_attr($static_credentials['sf_api_url'] ?? 'https://concilig.my.salesforce.com/services/data/v59.0/composite/sobjects'); ?>"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                        </div>
                    </div>
                </div>
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 pb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Client
                                ID</label>
                            <input type="text" name="mkc_client_id"
                                value="<?php echo esc_attr($static_credentials['mkc_client_id'] ?? ''); ?>"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Client
                                Secret</label>
                            <input type="password" name="mkc_client_secret"
                                value="<?php echo esc_attr($static_credentials['mkc_client_secret'] ?? ''); ?>"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Token
                                URL</label>
                            <input type="url" name="mkc_token_url"
                                value="<?php echo esc_attr($static_credentials['mkc_token_url'] ?? 'https://mchdb47kwgw19dh5mmnsw0fvhv2m.auth.marketingcloudapis.com/v2/token'); ?>"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">API Base
                                URL</label>
                            <input type="url" name="mkc_api_url"
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Token de
                                Autenticação *</label>
                            <input type="text" name="otima_wpp_token"
                                value="<?php echo esc_attr($static_credentials['otima_wpp_token'] ?? ''); ?>"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 pb-4">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Token de
                                Autenticação *</label>
                            <input type="text" name="otima_rcs_token"
                                value="<?php echo esc_attr($static_credentials['otima_rcs_token'] ?? ''); ?>"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                                placeholder="Bearer token para autenticação">
                        </div>
                ...
                <div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Dashboard
                            Password</label>
                        <input type="password" name="dashboard_password"
                            value="<?php echo esc_attr($static_credentials['dashboard_password'] ?? get_option('ga_dashboard_password', 'admin123')); ?>"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Password para acessar o Status
                            Dashboard (get_agendamentos)</p>
                    </div>
                </div>
                            ...
                            if (is_array($data) && !empty($data)) {
                                ...
                                <div class="credential-card p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700"
                                    ...
                                    <div class="flex items-start justify-between mb-3">
                                        <div>
                                            <h4 class="font-semibold text-gray-900 dark:text-white uppercase">
                                                <?php echo esc_html($provider_name); ?></h4>
                                            <p class="text-sm text-gray-600 dark:text-gray-400">Environment ID: <code
                                                    class="px-2 py-1 bg-gray-200 dark:bg-gray-700 rounded"><?php echo esc_html($env_id); ?></code>
                                            </p>
                                        </div>
                                        <div class="flex gap-2">
                                            <button
                                                class="edit-credential px-3 py-1 bg-blue-500 text-white text-sm rounded-lg hover:bg-blue-600 transition-colors">
                                                <i class="fas fa-edit mr-1"></i>Editar
                                            </button>
                                            <button
                                                class="delete-credential px-3 py-1 bg-red-500 text-white text-sm rounded-lg hover:bg-red-600 transition-colors">
                                    ...
                                    <div class="text-sm text-gray-700 dark:text-gray-300 space-y-1">
                                        <?php if ($provider_name === 'salesforce'): ?>
                                            ...
                                            <p><strong>Automation ID:</strong> <code
                                                    class="text-xs"><?php echo esc_html($data['automation_id'] ?? ''); ?></code></p>
            ...
            <form id="create-credential-form" class="space-y-6">
                ...
                <div id="url-token-fields" class="hidden space-y-4">
                    <div>
                        ...
                        <input type="url" id="create-url" name="url" placeholder="https://provider.api.com/endpoint"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        ...
                        <input type="text" id="create-token" name="token"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                    </div>
                </div>
                ...
                <div id="salesforce-fields" class="hidden space-y-4">
                    <div>
                        ...
                        <input type="text" id="create-operacao" name="operacao" placeholder="BV_VEIC_ADM_Tradicional"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                ...
                <div id="rcs-fields" class="hidden space-y-4">
                    <div>
                        ...
                        <input type="text" id="create-chave-api" name="chave_api" placeholder="sua-chave-api"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        ...
                        <input type="text" id="create-codigo-equipe" name="codigo_equipe" placeholder="codigo-equipe"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        ...
                        <input type="text" id="create-codigo-usuario" name="codigo_usuario" placeholder="codigo-usuario"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                    </div>
                </div>
                ...
                <div class="flex gap-3 pt-4">
                    <button type="submit"
                        class="flex-1 px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors">
